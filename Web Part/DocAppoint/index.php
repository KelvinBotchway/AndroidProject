...
<html lang="en">
    ...
    <body>
        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.php">Kaybee Clinic</a>
                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <form action="<?php $_PHP_SELF ?>" method="POST" accept-charset="utf-8" class="form" role="form">
                                        ...
                                        <input type="date" name="confirm_password" value="" class="form-control input-lg" placeholder="Confirm Password"  required/>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-5">
                        ...
                        <p>Below is the Doctor's Schedule. Please <span class="label label-danger">login</span> to make an appointment. </p>
        ...
        <div class="copyright-bar bg-black">
            <div class="container">
                <p class="pull-left">©Kaybee Clinic<br></p>
                <p><br>Monday-Sunday <br>
                    6:00am - 11:00pm</p>
